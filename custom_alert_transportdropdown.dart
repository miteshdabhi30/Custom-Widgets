...
class CustomAlertForTransport extends StatelessWidget {
  const CustomAlertForTransport({
    super.key,
  });
              ...
              child: StatefulBuilder(
                builder: (context, setState) {
                  return CustomDropdown.search(
                    ...
                    // initialItem: provider.initialTransport,
                    onChanged: (value) {
                    ...
                    hintText: provider.selectedTransport != "" ? provider.selectedTransport : provider.initialTransport == ""
                        ? "Select Transport"
                        : provider.initialTransport,
